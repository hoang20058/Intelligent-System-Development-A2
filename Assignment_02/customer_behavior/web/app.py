"""
Web Application Server — Giao diện Web Dự đoán CSAT Khách hàng (Desktop Web UI)
Chạy: uvicorn app:app --port 8103
...
app = FastAPI(title="Customer Behavior Web Dashboard", version="1.0.0")
