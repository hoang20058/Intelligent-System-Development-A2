"""
Mobile Application Server — Giao diện Di động Dự đoán Tiểu đường (Touch / Mobile Client)
Chạy: uvicorn app:app --port 8201
...
app = FastAPI(title="Diabetes Mobile Application", version="1.0.0")
