"""
Web Application Server — Giao diện Web Định giá Nhà (Desktop Web UI)
Chạy: uvicorn app:app --port 8102
Truy cập: http://localhost:8102
"""
...
app = FastAPI(title="House Price Web Dashboard", version="1.0.0")
...
def index(request: Request):
    return templates.TemplateResponse(request=request, name="index.html", context={"states": state_classes})
